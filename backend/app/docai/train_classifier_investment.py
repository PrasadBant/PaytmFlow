"""Trains and evaluates the INVESTMENT document classifier, reusing the
...
architecture, only Investment's own data/paths passed in.

Run: `uv run python -m app.docai.train_classifier_investment`
"""

from __future__ import annotations

from app.docai.dataset.generate_investment import DATASET_ROOT, SEED
from app.docai.train_classifier import other_pack_roots, train_and_evaluate

JOURNEY_TYPE = "INVESTMENT"
MODEL_VERSION = "investment-classifier-v1"
...
if __name__ == "__main__":
    report = train_and_evaluate(
        ...
        seed=SEED,
        representative_expected_doc_type="CANCELLED_CHEQUE",
    ...
    print(
        ...
        "see data/docai/investment/reports/classifier_metrics.json"
    )
