"""Trains and evaluates the ACCOUNT_OPENING document classifier, reusing the
...
architecture, only Account Opening's own data/paths passed in.

Run: `uv run python -m app.docai.train_classifier_account_opening`
"""

from __future__ import annotations

from app.docai.dataset.generate_account_opening import DATASET_ROOT, SEED
from app.docai.train_classifier import train_and_evaluate

JOURNEY_TYPE = "ACCOUNT_OPENING"
MODEL_VERSION = "account-opening-classifier-v1"
...
if __name__ == "__main__":
    report = train_and_evaluate(
        ...
        seed=SEED,
        representative_expected_doc_type="SIGNATURE_SPECIMEN",
    )
    ...
    print(
        ...
        "see data/docai/account_opening/reports/classifier_metrics.json"
    )
