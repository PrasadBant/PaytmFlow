"""Trains and evaluates the KYC document classifier, reusing the SAME
shared TF-IDF+LogisticRegression mechanism as Lending/Insurance
(`app.docai.train_classifier.train_and_evaluate`) - no duplicated
architecture, only KYC-specific data/paths passed in.

Run: `uv run python -m app.docai.train_classifier_kyc`
"""
...
if __name__ == "__main__":
    ...
    print(
        ...
        "see data/docai/kyc/reports/classifier_metrics.json"
    )
