"""Trains and evaluates the INSURANCE document classifier, reusing the
SAME shared TF-IDF+LogisticRegression mechanism as Lending
(`app.docai.train_classifier.train_and_evaluate`) - no duplicated
architecture, only Insurance-specific data/paths passed in.

Run: `uv run python -m app.docai.train_classifier_insurance`
"""

from __future__ import annotations

from app.docai.dataset.generate_insurance import DATASET_ROOT, SEED
from app.docai.train_classifier import other_pack_roots, train_and_evaluate

JOURNEY_TYPE = "INSURANCE"
MODEL_VERSION = "insurance-classifier-v1"
...
if __name__ == "__main__":
    report = train_and_evaluate(
        ...
        seed=SEED,
        representative_expected_doc_type="MEDICAL_DISCHARGE_SUMMARY",
    ...
    print(
        ...
        "see data/docai/insurance/reports/classifier_metrics.json"
    )
